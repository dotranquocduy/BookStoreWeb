...
{
    [Authorize]
    public class QuanLySachController : ControllersTemplateDesign
    {
        // GET: QuanLySach
        ...
        //nhân bản sản phẩm
        [HttpGet]
        public ActionResult Duplicate(int MaSach)
        {
            //Lấy ra đối tượng sách theo mã 
            Sach sach = db.Saches.SingleOrDefault(n => n.MaSach == MaSach);
            if (sach == null)
        ...
        public ActionResult DuplicateConfirm(int MaSach)
        {
            Sach sach = db.Saches.SingleOrDefault(n => n.MaSach == MaSach);
            if (sach == null)
            {
            ...
            Sach DuplicateBook = (Sach)sach.Clone();
            db.Saches.Add(DuplicateBook);
            db.SaveChanges();
            //db.Saches.Add(sach);
            //db.SaveChanges();
        ...
        protected override void PrintRoutes()
        {
            ...
            GET: Admin/QuanLySach/Edit/:MaSach
            GET: Admin/QuanLySach/Delete/:MaSach
            POST: Admin/QuanLySach/Create/:MaSach
            POST: Admin/QuanLySach/Edit/:MaSach
            POST: Admin/QuanLySach/XemCTCD/:MaSach
            POST: Admin/QuanLySach/XacNhanXoa/:MaSach
            POST: Admin/QuanLySach/Remove/:MaSach
            ");
        }
