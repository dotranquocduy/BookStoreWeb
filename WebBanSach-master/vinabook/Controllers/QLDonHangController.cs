...
{
    [Authorize]
    public class QLDonHangController : ControllersTemplateDesign
    {
        // GET: QLDonHang
        ...
        protected override void PrintRoutes()
        {
            ...
            Routes: 
            GET: Admin/QLDonHang
            GET: Admin/QLDonHang/Edit/:madh
            GET: Admin/QLDonHang/Delete/:madh
            POST: Admin/QLDonHang/Create/:madh
            POST: Admin/QLDonHang/Edit/:madh
            POST: Admin/QLDonHang/XemCTCD/:madh
            POST: Admin/QLDonHang/XacNhanXoa/:madh
            POST: Admin/QLDonHang/Remove/:madh
            ");
        }
    }
}