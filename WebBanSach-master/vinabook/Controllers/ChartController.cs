...
namespace Vinabook.Controllers
{
    public class ChartController : Controller
    {
        ...
        {
            string conn = @"data source=DESKTOP-84RJUM7\SQLEXPRESS;initial catalog=QuanLyBanSach;user id=sa;password=123;MultipleActiveResultSets=True;App=EntityFramework";
