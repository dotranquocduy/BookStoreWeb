...
{
    [Authorize]
    public class QuanLyKHController : ControllersTemplateDesign
    {
        // GET: QuanLyKH
        ...
        protected override void PrintRoutes()
        {
            ...
            Routes: 
            GET: Admin/QuanLyKH
            GET: Admin/QuanLyKH/Edit/:MaKH
            GET: Admin/QuanLyKH/Delete/:MaKH
            POST: Admin/QuanLyKH/Create/:MaKH
            POST: Admin/QuanLyKH/Edit/:MaKH
            POST: Admin/QuanLyKH/XemCTCD/:MaKH
            POST: Admin/QuanLyKH/XacNhanXoa/:MaKH
            POST: Admin/QuanLyKH/Remove/:MaKH
            ");
        }
    }
}